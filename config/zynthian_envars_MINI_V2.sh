...
export ZYNTHIAN_KIT_VERSION="MINI_V2"
...
#Audio Config
export SOUNDCARD_NAME="HifiBerry DAC+ light"
export SOUNDCARD_CONFIG="dtoverlay=hifiberry-dac\nforce_eeprom_read=0"
export SOUNDCARD_MIXER="Digital_Left,Digital_Right"
export JACKD_OPTIONS="-P 70 -s -S -d alsa -d hw:sndrpihifiberry -r 48000 -p 256 -n 2 -o 2 -X raw"
...
export ZYNTHIAN_WIRING_LAYOUT="MINI_V2"
...
export ZYNTHIAN_WIRING_CUSTOM_SWITCH_13__UI_SHORT="BACK S"
...
export ZYNTHIAN_WIRING_CUSTOM_SWITCH_13__UI_BOLD="BACK B"
...
export ZYNTHIAN_WIRING_CUSTOM_SWITCH_13__UI_PUSH="BACK S"
...
export ZYNTHIAN_WIRING_CUSTOM_SWITCH_14__UI_BOLD=""
...
export ZYNTHIAN_WIRING_CUSTOM_SWITCH_14__UI_SHORT=""
